...
**Sonnet with seedkit scores above Opus without it.** On the four cases Opus ran, it reached 29/32 where seedkit reached 32/32. The knowledge lives in the reference files, so the model doesn't have to supply it.
